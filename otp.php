...
if(empty($err))
{
  $sql = "SELECT id, email, otp FROM users WHERE otp = ?";
...
<div id="message">
  ...
  <p class="optional">We send one time password on your registered email address. Please enter that here. <br> For now you can <a href="ln.php">login</a> without otp too, but if you enter correct email address then you recived the otp. There is a chance that you didn't get otp because there is problem here on this domain with mail functionality we will soon launch this service on our domain.
</div>
